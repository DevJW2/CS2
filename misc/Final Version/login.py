...
PASSWORD_EXPIRE_TIME = 60 * 10  # 1 minutes
...
if 'username' in form and 'password' in form:
    ...
    body = '''
    <h1 style="text-align: center; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">Log in:</h1>
    <form action="login.py" style="text-align: center;">
    ...
    <a href="createaccount.py" style="color: darkcyan; text-decoration: none;"> Go Create an Account </a>'''
